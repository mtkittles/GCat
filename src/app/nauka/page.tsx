...
export const metadata = { title: "Nauka G-kodu krok po kroku — KodG.pl" };
  ...
  return (
    <div className="grid gap-5">
      ...
      <ol className="grid gap-2 max-w-2xl">
        {lessons.map((l, i) => (
          <li key={l.slug}><Link href={`/nauka/${l.slug}`} className="flex gap-4 bg-white border border-line rounded-md p-4 hover:border-ink">
            <span className="font-mono text-2xl font-bold text-amber w-8">{i + 1}</span>
