...
export const buildup: Record<Track, { title: string; lines: BuildLine[] }> = {
  frezowanie: {
    ...
    lines: [
      ...
      { code: "G03 I-3. Z-1.", since: "F6.3", note: "Spirala: pełny obrót wokół X60 Y25 i 1 mm w dół." },
      { code: "G03 I-3. Z-2.", since: "F6.3", note: "Spirala." },
      { code: "G03 I-3. Z-3.", since: "F6.3", note: "Spirala." },
      { code: "G03 I-3. Z-4.", since: "F6.3", note: "Spirala do pełnej głębokości." },
