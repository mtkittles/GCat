...
export default function TechGrid({ className = "" }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 480 300" className={`techgrid ${className}`} aria-hidden="true">
      ...
      <path d="M110 200 L230 200 A60 60 0 0 1 290 140 L290 90" stroke="#F97316" strokeWidth="2.5" fill="none" strokeLinecap="round" className="draw" style={{ ["--len" as string]: 340 }} />
      ...
      <circle cx="290" cy="90" r="13" fill="none" stroke="#F97316" strokeOpacity=".45" strokeWidth="1.5" className="pulse" />
      <text x="302" y="86" fontSize="10.5" fill="#F97316" fontFamily="var(--font-mono)" className="pulse">X290 Y90</text>
